...
export const FIRST_NAME_ID = "reJw3rUT"; // driver-0
export const MIDDLE_INITIAL_ID = "ElI9UkWD"; // driver-1
export const LAST_NAME_ID = "Iv7jSfKw"; // driver-2
export const DATE_OF_BIRTH_ID = "oMObMoQs"; // driver-4
export const STREET_ADDRESS_ID = "bqPmjHhl"; // driver-5
export const CITY_ID = "mfUnfGGG"; // driver-6
export const STATE_ID = "I5sdJ3MP"; // driver-7
export const ZIP_CODE_ID = "g9aneW3g"; // driver-8
export const SEX_ID = "cGeoDWm1"; // driver-10
