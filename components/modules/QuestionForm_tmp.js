...
class QuestionForm extends Component {
  ...
  render() {
    ...
    const renderSingleQuestion = (question, props) => {
    ...
    const renderedQuestions = questionsData.map((question) => {
      return renderSingleQuestion(question, questionProps(question.type, {...question,...questionData(question.type),questionDetail}));
    });
