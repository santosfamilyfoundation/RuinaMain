        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
              ...
              <Layout style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                <Text style={{textAlign:'center', padding:15}}>This feature has been made, however is pending licensing agreement with its integration partner. We apologize that we cannot show you this feature at this time.</Text>
              </Layout>
